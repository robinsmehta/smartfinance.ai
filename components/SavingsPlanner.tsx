...
export default function SavingsPlanner() {
  ...
  const compute = (e: React.FormEvent) => {
    ...
    setPlan({ monthlySaving, monthsLeft: months, progress, totalNeeded: remaining });
  };
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <form onSubmit={compute} className="space-y-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="w-full py-3 rounded-xl bg-cyan-600/80 hover:bg-cyan-600 text-white font-semibold text-sm transition-colors shadow-lg shadow-cyan-600/10 flex items-center justify-center gap-2"
          >
